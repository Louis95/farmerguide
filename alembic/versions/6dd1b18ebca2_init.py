...
Revision ID: 6dd1b18ebca2
Revises: 
Create Date: 2024-08-07 06:20:15.998221
...
def upgrade():
    ...
    sa.Column('harvested_on', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    ...
    op.create_table('farming_advice',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('farm_id', sa.Integer(), nullable=True),
    ...
    op.create_table('crop_diagnosis',
    sa.Column('id', sa.Integer(), nullable=False),
